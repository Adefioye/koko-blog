...
![VP-k correlation plot](/static/images/vp_k_corr.png)
...
![Scatter plot](/static/images/scatter-plot-corr.png)
...
![Median rank difference plot](/static/images/median-rank-diff.png)

> Figure 2: Distribution of median rank difference for low and high qa accuracy subjects

## Conclusion
Residual stream and MLP probes show the strongest correlations (0.61-0.62), while attention and VP-50 features lag. The VP-50 dip and slope collapse remain the main discrepancy. However, I believe it can be made more predictive through hyperparameter tuning.
...
@article{abdulhakeem2026keen-paper-reproduction,
  ...
  year={"2026"},
  month={"January"},
  url={"https://adefioye.github.io/koko-blog/keen-paper-repro"}
}
```
